function DQ(s, root) {
  ...
  return {
    ...
    addClass (n)      { iter(e => e.classList.add(n)); return this },
    removeClass (n)   { iter(e => e.classList.remove(n)); return this },
    toggleClass (n)   { iter(e => e.classList.toggle(n)); return this },
